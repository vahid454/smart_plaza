  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: GridView.count(
        crossAxisCount: 2,
        children: [
          _buildDashboardButton(context, "Add Item", Icons.add, () => Navigator.push(context, MaterialPageRoute(builder: (_) => AddItemScreen()))),
          _buildDashboardButton(context, "Sell Item", Icons.sell, () {}),
